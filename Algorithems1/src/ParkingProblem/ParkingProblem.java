...
public class ParkingProblem {
	...
	public static int parkingProblemWithLinearPart(DoubleLinkedList list) {
		//נגדיר כמו שתי תנאי התחלה כי יש לי מצביע שקופץ ישר 2 צעדים
	...
	public static int parkingProblemWithLinearPart(LinkedList list) {
		...
		Node m = list.getHead().getNext().getNext();
		//m = jump 2  , n= jump 1
		...
		//אם הוא הגיע לנאל זאת אומרת שאין לנו בכלל מעגל נשלח לפונקציה שתספור כמה נודים יש לנו 
		if(m == null) 

...
public class MaxMax {
    ...
    /**
     * Find the minimum and the maximum elements in array Complexity: O(n) -
     * 3/2(n-1) comparisons
     *
    ...
    /**
     * Find the 2 maximum elements in array - Recursive Complexity: O(n) - (n +
     * log n) comparisons
     *
     * @return number of comparisons
     */
    ...
    /**
     * Find the 2 maximum elements in array - Inductive Complexity: O(n) - (n +
     * log n) comparisons
     *
     * @return number of comparisons
     */
    ...
    public static void getAverageofMethod(int method, int checks, int max_size) {
        ...
        for (int i = 0; i < checks; i++) {
            ...
            if (method == 1) {
                sum += (double) maxMaxM1(arr) / arr.length;
            }
            if (method == 2) {
                sum += (double) maxMaxM2Recursive(arr) / arr.length;
            }
            if (method == 3) {
                sum += (double) maxMaxM2Induction(arr) / arr.length;
            }
        }
